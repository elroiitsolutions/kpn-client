              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                ...
                {project.locationAdvantages.schoolsColleges && (
                  <div className="rounded-[24px] border border-slate-100 bg-white p-6 shadow-sm">
                    ...
                    <ul className="space-y-2 text-xs font-semibold text-slate-600">
                      {project.locationAdvantages.schoolsColleges.map((item, idx) => (
                ...
                {project.locationAdvantages.hospitals && (
                  <div className="rounded-[24px] border border-slate-100 bg-white p-6 shadow-sm">
                    ...
                    <ul className="space-y-2 text-xs font-semibold text-slate-600">
                      {project.locationAdvantages.hospitals.map((item, idx) => (
                        <li key={idx} className="flex items-center gap-2">
                          <span className="h-1.5 w-1.5 rounded-full bg-[#f12131]" />
                          {item}
                        </li>
                ...
                {project.locationAdvantages.publicFacilities && (
                  <div className="rounded-[24px] border border-slate-100 bg-white p-6 shadow-sm">
                    ...
                    <ul className="space-y-2 text-xs font-semibold text-slate-600">
                      {project.locationAdvantages.publicFacilities.map((item, idx) => (
                        <li key={idx} className="flex items-center gap-2">
                          <span className="h-1.5 w-1.5 rounded-full bg-[#f12131]" />
                          {item}
                        </li>
                ...
                {project.locationAdvantages.corporateOffices && (
                  <div className="rounded-[24px] border border-slate-100 bg-white p-6 shadow-sm">
                    ...
                    <ul className="space-y-2 text-xs font-semibold text-slate-600">
                      {project.locationAdvantages.corporateOffices.map((item, idx) => (
                        <li key={idx} className="flex items-center gap-2">
                          <span className="h-1.5 w-1.5 rounded-full bg-[#f12131]" />
                          {item}
                        </li>
